...
if( $_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	$sql = 'SELECT Users.Username, Users.FirstName, Users.LastName, EventRSVPs.EventID FROM EventRSVPs Left Join Users on EventRSVPs.RSVPUser=Users.Username WHERE EventID = "' . $EventID . '";';
